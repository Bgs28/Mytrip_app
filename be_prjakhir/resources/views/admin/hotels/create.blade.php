...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <div class="flex items-center gap-4 mb-6">
        ...
        <h1 class="text-xl font-bold text-gray-900">🏨 Tambah Hotel</h1>
    </div>
    ...
    <form method="POST" action="{{ route('admin.hotels.store') }}" class="space-y-6" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" 
                       ...
                       placeholder="Contoh: Hotel Ambatugun" required>
                @error('name')
            ...
            <div>
                ...
                <input type="text" name="location" value="{{ old('location') }}" 
                       ...
                       placeholder="Contoh: Padang" required>
                @error('location')
                    <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div>
            ...
            <textarea name="description" rows="4" 
                      ...
                      placeholder="Tulis fasilitas dan detail hotel...">{{ old('description') }}</textarea>
            @error('description')
                <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <div id="imagePreview" class="mt-2 hidden">
                <img id="imagePreviewImg" class="h-32 w-32 object-cover rounded-lg border border-gray-200">
            </div>
            @error('image')
                <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
            @enderror
