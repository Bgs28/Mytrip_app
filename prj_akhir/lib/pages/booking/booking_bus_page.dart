...
class BookingBusPage extends StatefulWidget {
  const BookingBusPage({super.key});
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: const [
                          Text(
                            'Cari tiket bus cepat dan mudah',
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 18,
                          ...
                          SizedBox(height: 8),
                          Text(
                            'Pilih terminal, tanggal, dan jumlah penumpang.',
